...
import loki.language.generation.bytecode.CGenerationBytecode
...
class GenerationRuleBytecode[RULE_CONTEXT <: RuleContext](generationContext:CGenerationContextBytecode, ruleContext:RULE_CONTEXT)
