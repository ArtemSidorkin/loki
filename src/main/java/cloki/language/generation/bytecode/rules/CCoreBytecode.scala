...
import cloki.language.generation.rules.CCore
import org.antlr.v4.runtime.RuleContext


protected class CCoreBytecode[RULE_CONTEXT <: RuleContext](generationContext:CGenerationContextBytecode, ruleContext:RULE_CONTEXT)
