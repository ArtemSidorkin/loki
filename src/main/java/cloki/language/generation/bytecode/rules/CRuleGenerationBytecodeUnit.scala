...
{
	protected class CCoreBytecodeUnit(generationContext:CGenerationContextBytecode, ruleContext:UnitContext)
		extends CCoreBytecode(generationContext, ruleContext) with CMixinRuleGenerationUnit
	{
		override def enter()
		{
			pushUnitFrame()
	...
	override protected def getCore(generationContext:CGenerationContextBytecode, ruleContext:UnitContext) =
		new CCoreBytecodeUnit(generationContext, ruleContext)
}
