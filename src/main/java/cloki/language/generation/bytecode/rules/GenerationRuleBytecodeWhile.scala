...
import cloki.language.generation.rules.mixins.GenerationRuleMixinWhile
...
class GenerationRuleBytecodeWhile(generationContext:CGenerationContextBytecode, ruleContext:WhileContext)
	extends GenerationRuleBytecode(generationContext, ruleContext) with GenerationRuleMixinWhile
{
