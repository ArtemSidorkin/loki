...
{
	public static final LInstanceUnitDescriptor<LEqualityNumberBinaryOperation> DESCRIPTOR =
		new LInstanceUnitDescriptor<>("==", LEqualityNumberBinaryOperation.class, LEqualityNumberBinaryOperation::new);
